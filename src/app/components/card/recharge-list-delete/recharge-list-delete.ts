...
@Component({
  selector: 'app-recharge-list-delete',
  imports: [DecimalPipe, DatePipe],
  templateUrl: './recharge-list-delete.html',
  styleUrl: './recharge-list-delete.css',
})
export class RechargeListDelete implements OnInit {
  ...
  confirmDelete(): void {
    ...
    this.rechargeService.deleteRecharge(id).subscribe({
      next: () => {
        this.recharges.update(list => list.filter(r => r.RechargeId !== id));
        this.toastService.show('Recarga eliminada correctamente', 'success');
